...
async def list_materials(status: Optional[str] = None,
    ...
    # Task 4: legacy records without ``active`` remain active. Deactivated
    # records stay in Mongo for MRF/PO/GRN/DC history but are not offered for
    # new requisitions.
    filt: Dict[str, Any] = {"active": {"$ne": False}}
